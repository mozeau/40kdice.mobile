...
function loadDefenseProfile(profileKey) {
    ...
    var profile = defenseProfiles[profileKey];

    document.getElementById('t').value = profile.t;
    document.getElementById('save').value = profile.save;
    document.getElementById('invulnerable').value = profile.invulnerable;
    document.getElementById('wounds').value = profile.wounds;
    document.getElementById('fnp').value = profile.fnp;
}
